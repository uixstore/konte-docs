...
This is our support system: https://uix.ticksy.com/
...
![Extend support](_images/extend-support.png)

**Step 1** – Login to your ThemeForest account and go to the Downloads tab.

**Step 2** – Locate your Konte purchase. On there, you’ll see how many months of support you have remaining, and beside it there’s an **Extend Now** link.

**Step 3** – Click the **Extend Now** link, and it will redirect you to the Konte Theme's item page.
...
1. Make sure you are running the [latest version of Konte](installation/update-theme.md) and the latest version of [WordPress](https://wordpress.org/).
1. Check our Documentation and search in our [support system](https://uix.ticksy.com/) for the answer to your question.
1. Disable any additional 3rd party plugins you may be using to see if it fixes the issue.
1. Switch back to the default theme (Tweentyseventeen) to see if it fixes the issue. If it does, you can ensure this is a bug of Konte.

#### Common Questions

1. **What will happen if I don't reenew the item support?**

	The only thing that changes is that you will not be granted access to hands on support. You will however continue to receive theme updates that contain bug fixes, patches and new features and access to our online documentation, help files.

1. **When can I renew the item support?**
...
1. **Where can I place my support ticket?**

	You can visit our [Support System](http://uix.ticksy.com/) to place your tickets. It requires you to login with Envato account which is the account you used to purchased Konte on ThemeForest.