...
When you purchase our theme on ThemeForest, you need to download the theme package from your themeforest account. Navigate to your downloads tab on ThemeForest and find Konte. Click the download button to see the two options. The **All files & documentation** contain everything, the **Installable WordPress** Theme is just the installable WordPress theme file. Below is a full list of everything that is included when you download the main files, along with a brief description of each item.

- `konte.zip`: main theme file that need to be uploaded to host to install Konte theme.
- `konte-child.zip`: the basic child theme file for people want to customize the theme.
