...
By default, WooCommerce shows variations of variable products as drop-down selectors. From the version 1.1.0, Konte supports to display them in a nicer way, as swatches. In order to have this, you must install the [WCBoost - Variation Swatches](https://wcboost.com/plugin/product-variation-swatches/) plugin. This plugin will add more options to product attributes and allows you set an attribute type as **Color**, **Image**, **Label**, or **Button**.

![Product attribute types](_images/product--attribute-type.png)
...
![Product attribute color](_images/product--attribute-color.png)

![Product attribute size](_images/product--attribute-size.png)