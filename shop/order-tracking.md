...
After created the _Order Tracking_ page, please go to **WooCommerce > Settings** then select **Advanced** tab. You will see an option for selecting what page is _Order Tracking_ page.

![Order tracking page setting](_images/woocommerce-order-tracking-setting.png)
